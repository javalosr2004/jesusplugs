...
def checkout(cart_id: int, cart_checkout: CartCheckout):
    ...
    with db.engine.begin() as connection:
        ...
        if total_quantity > 0:
            ...
            connection.execute(sqlalchemy.update(customer_table).values(completed=1).where(carts_table.c.customer_id == customer_table.c.customer_id, carts_table.c.id == cart_id))
